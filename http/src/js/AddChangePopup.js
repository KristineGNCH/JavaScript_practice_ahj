export default class AddChangePopup {
  ...
  showAdding() {
    ...
    this.sample.querySelector('.button[data-name="change"]').className =
      "button d_none";
    this.sample.querySelector(".popup__title.change").className =
      "popup__title change d_none";
    this.sample.querySelector(".popup__title.add").className =
      "popup__title add";
  }

  showUpdate() {
    this.sample.classList.add("open");
    this.sample.querySelector('.button[data-name="save"]').className =
      "button d_none";
    this.sample.querySelector('.button[data-name="change"]').className =
      "button";
    this.sample.querySelector(".popup__title.change").className =
